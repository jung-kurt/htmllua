...
int luaopen_gumbo_util(lua_State *L);
...
static void loadextra (lua_State *L) {
  ...
  require(L, "discount",  luaopen_discount);
  require(L, "gumbo.util",  luaopen_gumbo_util);
  require(L, "gumbo.parse",  luaopen_gumbo_parse);
}
